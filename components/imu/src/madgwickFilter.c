...
static float invSampleFreq; // unused
static float roll;
static float pitch;
static float yaw;
...
static void begin(float sampleFrequency)
{
...
void eulerAngles(float *roll_, float *pitch_, float *yaw_)
{
    *roll_ = getRoll();
    *pitch_ = getPitch();
    *yaw_ = getYaw();
