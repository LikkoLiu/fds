...
static esp_ble_adv_data_t adv_data = {
    ...
    .min_interval = 0x0400, //slave connection min interval, Time = min_interval * 1.25 msec
    .max_interval = 0x0800, //slave connection max interval, Time = max_interval * 1.25 msec
    .appearance = 0x00,
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_READ_EVT: {
        ...
        rsp.attr_value.value[0] = ucFallProbPara;
